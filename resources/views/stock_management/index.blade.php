    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-8">
            ...
            <div class="flex gap-4">
                <!-- <button class="px-4 py-2 bg-green-600/20 text-green-800 rounded-lg flex items-center gap-2">
                    Filter
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/>
                    </svg>
                </button> -->
                <a href="{{ route('editOrcreate') }}" class="px-4 py-2 bg-green-800 text-white rounded-lg hover:bg-green-700 transition-colors">
                    Tambah Produk
                </a>
            </div>
        </div>
